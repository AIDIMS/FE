...
!(function (e, t) {
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			? define('cornerstoneWADOImageLoader', [], t)
			: 'object' == typeof exports
				? (exports.cornerstoneWADOImageLoader = t())
				: (e.cornerstoneWADOImageLoader = t());
})(this, function () {
	return (
		(a = {}),
		(n.m = r =
			[
				...
				function (e, t, r) {
					...
					function a() {
						...
						if (!(m || ((m = CharLS()) && m._jpegls_decode)))
					...
					(r.d(t, 'b', function () {
						...
						(t.a = function (e, t) {
							...
							var r = (function (e, t) {
								...
								return (
									d.bitsPerSample <= 8
										? ((d.pixelData = new Uint8Array(d.width * d.height * d.components)),
											d.pixelData.set(new Uint8Array(m.HEAP8.buffer, p, d.pixelData.length)))
										: t
											? ((d.pixelData = new Int16Array(d.width * d.height * d.components)),
												d.pixelData.set(new Int16Array(m.HEAP16.buffer, p, d.pixelData.length)))
											: ((d.pixelData = new Uint16Array(d.width * d.height * d.components)),
												d.pixelData.set(new Uint16Array(m.HEAP16.buffer, p, d.pixelData.length))),
									m._free(r),
									m._free(p),
									m._free(a),
									m._free(n),
							...
							if (0 !== r.result && 6 !== r.result)
								throw new Error(
									'JPEG-LS decoder failed to decode frame (error code '.concat(r.result, ')')
								);
				...
				function (e, t, r) {
					...
					function n(e, t) {
						var r = (function (e, t, r) {
							...
							if (
								...
								h.ccall(
									...
									[a, e.length, n, o, i, l, s]
								)
							)
								return (
									console.log('[opj_decode] decoding failed!'),
									h._free(a),
									h._free(h.getValue(n, '*')),
									h._free(i),
									h._free(l),
									h._free(o),
									void h._free(s)
							...
							if (1 === t)
								if (Uint8Array.from) f.pixelData = Uint8Array.from(p);
								else {
									f.pixelData = new Uint8Array(d);
									for (var m = 0; m < d; m++) f.pixelData[m] = p[m];
								}
							else if (r)
								if (Int16Array.from) f.pixelData = Int16Array.from(p);
								else {
									f.pixelData = new Int16Array(d);
									for (var g = 0; g < d; g++) f.pixelData[g] = p[g];
								}
							else if (Uint16Array.from) f.pixelData = Uint16Array.from(p);
							else {
								f.pixelData = new Uint16Array(d);
								for (var v = 0; v < d; v++) f.pixelData[v] = p[v];
							}
							var x = new Date().getTime();
							return (
								(f.perf_timetodecode = x - u),
								h._free(a),
								h._free(n),
								h._free(c),
								h._free(o),
						...
						return (
							(e.columns = r.sx),
							(e.rows = r.sy),
							(e.pixelData = r.pixelData),
							1 < r.nbChannels && (e.photometricInterpretation = 'RGB'),
							e
						);
					}
					function o(e) {
						if (!e.usePDFJS && 'undefined' == typeof OpenJPEG)
							throw new Error('OpenJPEG decoder not loaded');
						if (!(h || ((h = OpenJPEG()) && h._jp2_decode)))
				...
				function (e, t, r) {
					...
					function a(e) {
						...
						!0 !== t || a
							? ((e.smallestPixelValue = r.min), (e.largestPixelValue = r.max))
							: (e.smallestPixelValue !== r.min &&
									console.warn(
										'Image smallestPixelValue tag is incorrect. Rendering performance will suffer considerably.'
									),
								e.largestPixelValue !== r.max &&
									console.warn(
				...
				function (e, t, r) {
							...
							16 === e.bitsAllocated
								? (a % 2 && ((r = r.slice(a)), (a = 0)),
									0 === e.pixelRepresentation
										? (e.pixelData = new Uint16Array(r, a, n / 2))
										: (e.pixelData = new Int16Array(r, a, n / 2)))
								: 8 === e.bitsAllocated || 1 === e.bitsAllocated
									? (e.pixelData = t)
									: 32 === e.bitsAllocated &&
										(a % 2 && ((r = r.slice(a)), (a = 0)),
										(e.pixelData = new Float32Array(r, a, n / 4))),
							e
						);
					};
					var f = function (e, t) {
					...
					var d = function (e, t) {
						if (8 === e.bitsAllocated)
							return e.planarConfiguration
								? (function (e, t) {
										for (
											var r = t,
												a = e.rows * e.columns,
												n = new ArrayBuffer(a * e.samplesPerPixel),
												o = new DataView(r.buffer, r.byteOffset),
												i = new Int8Array(r.buffer, r.byteOffset),
												l = new Int8Array(n),
												s = 0,
												u = o.getInt32(0, !0),
												c = 0;
											...
											for (var p = a * u; f < d; ) {
												var m = i[f++];
												if (0 <= m && m <= 127)
													for (var g = 0; g < m + 1 && s < p; ++g) ((l[s] = i[f++]), s++);
												else if (m <= -1 && -127 <= m)
													for (var v = i[f++], x = 0; x < 1 - m && s < p; ++x) ((l[s] = v), s++);
											}
										}
								...
								: (function (e, t) {
										for (
											...
											for (var p = a * u; f < d; ) {
												var m = i[f++];
												if (0 <= m && m <= 127)
													for (var g = 0; g < m + 1 && s < p; ++g)
														((l[s] = i[f++]), (s += e.samplesPerPixel));
												else if (m <= -1 && -127 <= m)
													for (var v = i[f++], x = 0; x < 1 - m && s < p; ++x)
						...
						if (16 === e.bitsAllocated)
							return (function (e, t) {
								for (
									var r = t,
										a = e.rows * e.columns,
										n = new ArrayBuffer(a * e.samplesPerPixel * 2),
										o = new DataView(r.buffer, r.byteOffset),
										i = new Int8Array(r.buffer, r.byteOffset),
										l = new Int8Array(n),
										s = o.getInt32(0, !0),
									...
									for (0 === p && (p = r.length); d < p; ) {
										var m = i[d++];
										if (0 <= m && m <= 127)
											for (var g = 0; g < m + 1 && c < a; ++g) ((l[2 * c + f] = i[d++]), c++);
										else if (m <= -1 && -127 <= m)
											for (var v = i[d++], x = 0; x < 1 - m && c < a; ++x)
												((l[2 * c + f] = v), c++);
									}
								}
								0 === e.pixelRepresentation
									? (e.pixelData = new Uint16Array(n))
									: (e.pixelData = new Int16Array(n));
								return e;
							})(e, t);
					...
					var p = function (e, t) {
						...
						return (
							...
							(r.colorTransform = !1),
							8 === e.bitsAllocated
								? ((e.pixelData = r.getData(e.columns, e.rows)), e)
								: 16 === e.bitsAllocated
									? ((e.pixelData = r.getData16(e.columns, e.rows)), e)
									: void 0
						);
					};
					var m = function (e, t) {
							if (
								'undefined' == typeof jpeg ||
								void 0 === jpeg.lossless ||
								void 0 === jpeg.lossless.Decoder
							)
							...
							return (
								0 === e.pixelRepresentation
									? 16 === e.bitsAllocated
										? (e.pixelData = new Uint16Array(n.buffer))
										: (e.pixelData = new Uint8Array(n.buffer))
									: (e.pixelData = new Int16Array(n.buffer)),
								e
							);
						},
						g = r(1),
					...
					t.a = function (e, t, r, a, n) {
						...
						if ('1.2.840.10008.1.2' === t) e = c(e, r);
						else if ('1.2.840.10008.1.2.1' === t) e = c(e, r);
						else if ('1.2.840.10008.1.2.2' === t) e = f(e, r);
						else if ('1.2.840.10008.1.2.1.99' === t) e = c(e, r);
						else if ('1.2.840.10008.1.2.5' === t) e = d(e, r);
						else if ('1.2.840.10008.1.2.4.50' === t) e = p(e, r);
						else if ('1.2.840.10008.1.2.4.51' === t) e = p(e, r);
						else if ('1.2.840.10008.1.2.4.57' === t) e = m(e, r);
						else if ('1.2.840.10008.1.2.4.70' === t) e = m(e, r);
						else if ('1.2.840.10008.1.2.4.80' === t) e = Object(g.a)(e, r);
						else if ('1.2.840.10008.1.2.4.81' === t) e = Object(g.a)(e, r);
						else if ('1.2.840.10008.1.2.4.90' === t) e = Object(v.a)(e, r, a, n);
						else {
							if ('1.2.840.10008.1.2.4.91' !== t)
								throw new Error('no decoder for transfer syntax '.concat(t));
						...
						if (i && void 0 !== l)
							for (var s = 0; s < e.pixelData.length; s++)
				...
				function (e, t, r) {
						...
						o = function (e, t) {
							...
							for (var r = e.length / 3, a = 0, n = 0, o = 0; o < r; o++) {
								var i = e[a++],
									...
									s = e[a++];
								((t[n++] = i + 1.402 * (s - 128)),
									(t[n++] = i - 0.34414 * (l - 128) - 0.71414 * (s - 128)),
									(t[n++] = i + 1.772 * (l - 128)),
									(t[n++] = 255));
							}
						},
						i = function (e, t) {
							...
							for (var r = e.length / 3, a = 0, n = 0, o = r, i = 2 * r, l = 0; l < r; l++) {
								var s = e[n++],
									...
									c = e[i++];
								((t[a++] = s + 1.402 * (c - 128)),
									(t[a++] = s - 0.34414 * (u - 128) - 0.71414 * (c - 128)),
									(t[a++] = s + 1.772 * (u - 128)),
									(t[a++] = 255));
							}
						};
					...
					var l = function (e, t) {
						for (
							var r = e.columns * e.rows,
								a = e.pixelData,
								n = e.redPaletteColorLookupTableData,
								o = e.greenPaletteColorLookupTableData,
								i = e.bluePaletteColorLookupTableData,
								l = e.redPaletteColorLookupTableData.length,
								s = 0,
								u = 0,
								c = e.redPaletteColorLookupTableDescriptor[1],
					...
					function s(e, t) {
						if (e.elements[t] && 6 === e.elements[t].length)
							return [e.uint16(t, 0), e.uint16(t, 1), e.uint16(t, 2)];
					}
					function u(e, t, r) {
					...
					var g = function (e) {
						...
						return (
							(function (e, t) {
								0 === e.uint16('x00280103')
									? ((t.smallestPixelValue = e.uint16('x00280106')),
										(t.largestPixelValue = e.uint16('x00280107')))
									: ((t.smallestPixelValue = e.int16('x00280106')),
										(t.largestPixelValue = e.int16('x00280107')));
							})(e, t),
							'PALETTE COLOR' === t.photometricInterpretation &&
								e.elements.x00281101 &&
								(function (e, t) {
									((t.redPaletteColorLookupTableDescriptor = s(e, 'x00281101')),
										(t.greenPaletteColorLookupTableDescriptor = s(e, 'x00281102')),
										(t.bluePaletteColorLookupTableDescriptor = s(e, 'x00281103')),
										0 === t.redPaletteColorLookupTableDescriptor[0] &&
											((t.redPaletteColorLookupTableDescriptor[0] = 65536),
											(t.greenPaletteColorLookupTableDescriptor[0] = 65536),
											(t.bluePaletteColorLookupTableDescriptor[0] = 65536)));
									var r = t.redPaletteColorLookupTableDescriptor[0],
										a = e.elements.x00281201.length === r ? 8 : 16;
									(t.redPaletteColorLookupTableDescriptor[2] !== a &&
										((t.redPaletteColorLookupTableDescriptor[2] = a),
										(t.greenPaletteColorLookupTableDescriptor[2] = a),
										(t.bluePaletteColorLookupTableDescriptor[2] = a)),
										(t.redPaletteColorLookupTableData = u(
											e,
											'x00281201',
											t.redPaletteColorLookupTableDescriptor
										)),
										(t.greenPaletteColorLookupTableData = u(
											e,
											'x00281202',
											t.greenPaletteColorLookupTableDescriptor
										)),
										(t.bluePaletteColorLookupTableData = u(
											e,
											'x00281203',
											t.bluePaletteColorLookupTableDescriptor
										)));
								})(e, t),
							t
						);
					...
					var h = function (e) {
						...
						return void 0 === r || void 0 === a
							? e.elements.x00283000 && 0 < e.elements.x00283000.length
								? 0
								: e.uint16('x00280103')
							: (function (e) {
					...
					var w = function (e, t, r) {
						...
						if (n) {
							var o = n.split('\\');
							if (!(r && o.length < r)) {
								for (var i = 0; i < o.length; i++) a.push(parseFloat(o[i]));
								return a;
							}
						}
					};
					...
					var m = function (e, t) {
							if (e && e.Value && !(t && e.Value.length < t)) {
								for (var r = [], a = 0; a < e.Value.length; a++) r.push(parseFloat(e.Value[a]));
								return r;
							}
						},
						b = [];
					...
					function P(e, t) {
						...
						if (a) {
							...
							if ('imagePlaneModule' === e) {
								...
								return (
									n &&
										((u = [parseFloat(n[0]), parseFloat(n[1]), parseFloat(n[2])]),
										(c = [parseFloat(n[3]), parseFloat(n[4]), parseFloat(n[5])])),
									{
							...
							if ('voiLutModule' === e)
								return { windowCenter: m(a['00281050'], 1), windowWidth: m(a['00281051'], 1) };
							...
							if ('sopCommonModule' === e)
								return { sopClassUID: d(a['00080016']), sopInstanceUID: d(a['00080018']) };
					...
					function D(e, t, r) {
						...
						for (var a = r, n = 0; n < e.length; n++) if (e[n] !== t[a++]) return !1;
						return !0;
					}
					...
					var A = function (o, i) {
							...
							return new Promise(function (t, r) {
								...
								(a.open('get', o, !0),
									...
									u.beforeSend(a, i, n, l),
									Object.keys(n).forEach(function (e) {
										a.setRequestHeader(e, n[e]);
									}),
									(l.deferred = { resolve: t, reject: r }),
									(l.url = o),
									(l.imageId = i),
									(a.onloadstart = function (e) {
										u.onloadstart && u.onloadstart(e, l);
										var t = { url: o, imageId: i };
									...
									(a.onreadystatechange = function (e) {
										u.onreadystatechange
											? u.onreadystatechange(e, l)
											: 4 === a.readyState && (200 === a.status ? t(a.response, a) : r(a));
									}),
									(a.onprogress = function (e) {
										var t,
											r,
											a = e.loaded;
										(e.lengthComputable && ((t = e.total), (r = Math.round((a / t) * 100))),
											u.onprogress && u.onprogress(e, l));
										var n = { url: o, imageId: i, loaded: a, total: t, percentComplete: r };
										s.triggerEvent(s.events, 'cornerstoneimageloadprogress', n);
									}),
									a.send());
							});
						},
						L = { xhrRequest: A, setOptions: C, getOptions: k };
					var S = function (e, t) {
						var r = {
							accept:
						...
						return new Promise(function (s, u) {
							A(e, t, r).then(function (e) {
								...
								var a = (function (e, t, r) {
										...
										for (var a = '', n = t; n < t + r; n++) a += String.fromCharCode(e[n]);
										return a;
									})(t, 0, r).split('\r\n'),
									n = (function (e) {
										for (var t = 0; t < e.length; t++) if ('--' === e[t].substr(0, 2)) return e[t];
									})(a);
								...
								s({
									...
									imageFrame: { pixelData: new Uint8Array(e, o, l) },
								});
							});
						});
					};
					var E,
						O = function (e) {
							var t = ce.cornerstone.metaData.get('imagePixelModule', e);
							return {
						...
						if (B.length) {
							for (var e = 0; e < R.length; e++)
								if ('ready' === R[e].status) {
									...
									return (
										(U.totalTimeDelayedInMS += r - t.added),
										(R[e].task = t),
										R[e].worker.postMessage(
											{ taskType: t.taskType, workerIndex: e, data: t.data },
											t.transferList
										),
										void U.numTasksExecuting++
									);
								}
					...
					function F(e) {
						if ('initialize' === e.data.taskType) ((R[e.data.workerIndex].status = 'ready'), V());
						else {
							var t = R[e.data.workerIndex].task.start;
							(R[e.data.workerIndex].task.deferred.resolve(e.data.result),
								(R[e.data.workerIndex].task = void 0),
								U.numTasksExecuting--,
								(R[e.data.workerIndex].status = 'ready'),
								U.numTasksCompleted++);
							var r = new Date().getTime();
					...
					function j() {
						if (!(R.length >= E.maxWebWorkers)) {
							...
							(R.push({ worker: e, status: 'initializing' }),
								e.addEventListener('message', F),
								e.postMessage({ taskType: 'initialize', workerIndex: R.length - 1, config: E }));
						}
					}
					function G(e) {
						if (((e = e || W), E)) throw new Error('WebWorkerManager already initialized');
						if (
							(((E = e).maxWebWorkers = E.maxWebWorkers || navigator.hardwareConcurrency || 1),
							!E.startWebWorkersOnDemand)
						)
							for (var t = 0; t < E.maxWebWorkers; t++) j();
					}
					var J = {
							initialize: G,
							loadWebWorkerTask: function (e, t) {
								(E.webWorkerTaskPaths.push(e),
									t && (E.taskConfiguration = Object.assign(E.taskConfiguration, t)));
							...
							getStatistics: function () {
								return (
									(U.maxWebWorkers = E.maxWebWorkers),
									(U.numWebWorkers = R.length),
									(U.numTasksQueued = B.length),
									U
								);
							},
							setTaskPriority: function (e) {
								for (
									var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0, r = 0;
									r < B.length;
									r++
								)
									if (B[r].taskId === e) {
					...
					var Y = function (i, e, l) {
							var s = new Date().getTime(),
								r = new Blob([e], { type: 'image/jpeg' });
							return new Promise(function (o, t) {
								var e = new FileReader();
								(void 0 === e.readAsBinaryString ? e.readAsArrayBuffer(r) : e.readAsBinaryString(r),
									(e.onload = function () {
										var n = new Image();
										((n.onload = function () {
											((l.height = n.height),
											...
											void 0 === e.readAsBinaryString
												? (n.src = 'data:image/jpeg;base64,'.concat(window.btoa(q(e.result))))
												: (n.src = 'data:image/jpeg;base64,'.concat(window.btoa(e.result))));
									}),
					...
					function Z(n, o, i, l) {
						var e = l.priority || void 0,
							...
							s = r.strict,
							u = r.decodeConfig;
						return !1 === r.useWebWorkers
							? (!1 === X && (Object(K.b)(u), Object(Q.b)(u), (X = !0)),
							...
							: J.addTask(
									'decodeTask',
									{ imageFrame: n, transferSyntax: o, pixelData: i, options: l },
									e,
									t
								).promise;
					}
					...
					var ee = function (e, r, t, a) {
						var n = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : {};
						return '1.2.840.10008.1.2' === r
							? Z(e, r, t, n)
							: '1.2.840.10008.1.2.1' === r
								? Z(e, r, t, n)
								: '1.2.840.10008.1.2.2' === r
									? Z(e, r, t, n)
									: '1.2.840.10008.1.2.1.99' === r
										? Z(e, r, t, n)
										: '1.2.840.10008.1.2.5' === r
											? Z(e, r, t, n)
											: '1.2.840.10008.1.2.4.50' === r
												? 8 !== e.bitsAllocated ||
													(3 !== e.samplesPerPixel && 4 !== e.samplesPerPixel)
													? Z(e, r, t, n)
													: Y(e, t, a)
												: '1.2.840.10008.1.2.4.51' === r
													? Z(e, r, t, n)
													: '1.2.840.10008.1.2.4.57' === r
														? Z(e, r, t, n)
														: '1.2.840.10008.1.2.4.70' === r
															? Z(e, r, t, n)
															: '1.2.840.10008.1.2.4.80' === r
																? Z(e, r, t, n)
																: '1.2.840.10008.1.2.4.81' === r
																	? Z(e, r, t, n)
																	: '1.2.840.10008.1.2.4.90' === r
																		? Z(e, r, t, n)
																		: '1.2.840.10008.1.2.4.91' === r
																			? Z(e, r, t, n)
																			: new Promise(function (e, t) {
					...
					function re(e, t) {
						var r = t.data;
						if ('RGB' === e.photometricInterpretation) te(e, r);
						else if ('YBR_RCT' === e.photometricInterpretation) te(e, r);
						else if ('YBR_ICT' === e.photometricInterpretation) te(e, r);
						else if ('PALETTE COLOR' === e.photometricInterpretation) l(e, r);
						else if ('YBR_FULL_422' === e.photometricInterpretation) te(e, r);
						else {
							if ('YBR_FULL' !== e.photometricInterpretation)
								throw new Error(
							...
							!(function (e, t) {
								0 === e.planarConfiguration ? o(e.pixelData, t) : i(e.pixelData, t);
							})(e, r);
						}
					}
					var ae = function (e, t) {
						if (
							((t = t || e.transferSyntax),
							8 === e.bitsAllocated &&
								'1.2.840.10008.1.2.4.50' === t &&
								(3 === e.samplesPerPixel || 4 === e.samplesPerPixel))
						)
							return !0;
					};
					var ne = function (m, e, g, t) {
						if (!e || !e.length)
							return Promise.reject(new Error('The file does not contain image data.'));
						var v = ce.cornerstone,
							x = document.createElement('canvas'),
							r = O(m),
							a = ee(r, g, e, x, t);
						return new Promise(function (p, e) {
							a.then(function (e) {
								var t = v.metaData.get('imagePlaneModule', m) || {},
									r = v.metaData.get('voiLutModule', m) || {},
									a = v.metaData.get('modalityLutModule', m) || {},
									n = v.metaData.get('sopCommonModule', m) || {},
									o = $(e.photometricInterpretation);
								if (
									!ae(e, g) &&
									((function (e) {
										32 === e.bitsAllocated
											? (e.pixelData = new Float32Array(e.pixelData))
											: 16 === e.bitsAllocated
												? 0 === e.pixelRepresentation
													? (e.pixelData = new Uint16Array(e.pixelData))
													: (e.pixelData = new Int16Array(e.pixelData))
												: (e.pixelData = new Uint8Array(e.pixelData));
									})(e),
									o)
								) {
									((x.height = e.rows), (x.width = e.columns));
									var i = x.getContext('2d').createImageData(e.columns, e.rows);
									(re(e, i), (e.imageData = i), (e.pixelData = i.data));
									var l = Object(z.a)(e.pixelData);
									((e.smallestPixelValue = l.min), (e.largestPixelValue = l.max));
								}
								var s = {
									imageId: m,
									color: o,
									columnPixelSpacing: t.columnPixelSpacing,
									columns: e.columns,
									height: e.rows,
									intercept: a.rescaleIntercept ? a.rescaleIntercept : 0,
									invert: 'MONOCHROME1' === e.photometricInterpretation,
									minPixelValue: e.smallestPixelValue,
									maxPixelValue: e.largestPixelValue,
									rowPixelSpacing: t.rowPixelSpacing,
									rows: e.rows,
									sizeInBytes: e.pixelData.length,
									slope: a.rescaleSlope ? a.rescaleSlope : 1,
									width: e.columns,
									windowCenter: r.windowCenter ? r.windowCenter[0] : void 0,
									windowWidth: r.windowWidth ? r.windowWidth[0] : void 0,
								...
								if (e.pixelData instanceof Float32Array) {
									var u = e.pixelData,
										c = (function (e) {
											...
											return { min: i, max: l, intPixelData: o, slope: r, intercept: a };
										})(u);
									((s.minPixelValue = c.min),
										(s.maxPixelValue = c.max),
										(s.slope = c.slope),
										(s.intercept = c.intercept),
										(s.floatPixelData = u),
										(s.getPixelData = function () {
											return c.intPixelData;
										}));
								} else
									s.getPixelData = function () {
										return e.pixelData;
								...
								if (
									(s.color && (s.getCanvas = function () {}),
									a.modalityLUTSequence &&
										0 < a.modalityLUTSequence.length &&
										(function (e) {
											return (
												'1.2.840.10008.5.1.4.1.1.12.1' !== e &&
												'1.2.840.10008.5.1.4.1.1.12.2.1' !== e
											);
										})(n.sopClassUID) &&
										(s.modalityLUT = a.modalityLUTSequence[0]),
									r.voiLUTSequence &&
										0 < r.voiLUTSequence.length &&
										(s.voiLUT = r.voiLUTSequence[0]),
									s.color && ((s.windowWidth = 255), (s.windowCenter = 127)),
									void 0 === s.windowCenter || void 0 === s.windowWidth)
								) {
									var f = s.maxPixelValue * s.slope + s.intercept,
										d = s.minPixelValue * s.slope + s.intercept;
									((s.windowWidth = f - d), (s.windowCenter = (f + d) / 2));
								}
								((x = null), p(s));
							}, e);
						});
					...
					function oe(i, l) {
						...
						return {
							promise: new Promise(function (a, n) {
								var e = y.get(i);
								if (void 0 === e) {
									var t = new Error('no metadata for imageId '.concat(i));
									return n(t);
								}
								var r,
									o = d(e['00080060']);
								((r = ['MG', 'CT'].includes(o)
									...
									S(u, i, r).then(function (e) {
										var t = (function (e) {
												...
												return a['transfer-syntax']
													? a['transfer-syntax']
													: e && !Object.keys(a).length && n[e]
														? n[e]
														: a.type && n[a.type]
															? n[a.type]
															: t;
										...
										ne(i, r, t, l).then(function (e) {
											var t = new Date().getTime();
											((e.loadTimeInMS = t - s), a(e));
										}, n);
									}, n));
							}),
							cancelFn: void 0,
					...
					var ie = {
						...
						metaDataManager: y,
						register: function (e) {
							(e.registerImageLoader('wadors', oe), e.metaData.addProvider(P));
						},
					};
					var le,
						se,
						ue = function (e) {
							(ie.register(e), Ae.register(e));
						},
						ce = {
							set cornerstone(e) {
								ue((le = e));
					...
					var fe = function (e) {
							...
							return { scheme: e.substr(0, r), url: a, frame: t };
						},
						de = 0,
						pe = {},
						me = {};
					function ge() {
						return { cacheSizeInBytes: de, numberOfDataSetsCached: Object.keys(pe).length };
					}
					var ve = {
						isLoaded: function (e) {
							return void 0 !== pe[e];
						...
						load: function (o) {
							...
							if (pe[o])
								return new Promise(function (e) {
									(pe[o].cacheCount++, e(pe[o].dataSet));
								});
							if (me[o]) return (me[o].cacheCount++, me[o]);
							var r = e(o, t),
								s = new Promise(function (a, n) {
									r.then(function (e) {
										...
										((pe[o] = { dataSet: t, cacheCount: s.cacheCount }),
											(de += t.byteArray.length),
											a(t),
											i.triggerEvent(i.events, 'datasetscachechanged', {
												uri: o,
												action: 'loaded',
												cacheInfo: ge(),
											}));
							...
							return ((s.cacheCount = 1), (me[o] = s));
						},
						unload: function (e) {
							var t = ce.cornerstone;
							pe[e] &&
								(pe[e].cacheCount--,
								0 === pe[e].cacheCount &&
									((de -= pe[e].dataSet.byteArray.length),
									delete pe[e],
									t.triggerEvent(t.events, 'datasetscachechanged', {
										uri: e,
										action: 'unloaded',
										cacheInfo: ge(),
									})));
					...
					function xe(e, t) {
						...
						if (n) {
							...
							if ('imagePlaneModule' === e) {
								...
								return (
									o &&
										((c = [parseFloat(o[0]), parseFloat(o[1]), parseFloat(o[2])]),
										(f = [parseFloat(o[3]), parseFloat(o[4]), parseFloat(o[5])])),
									{
					...
					function be(e, t) {
						...
						if (
							...
							var a = r.createJPEGBasicOffsetTable(e, e.elements.x7fe00010);
							return r.readEncapsulatedImageFrame(e, e.elements.x7fe00010, t, a);
						}
						return r.readEncapsulatedPixelDataFromFragments(e, e.elements.x7fe00010, t);
					}
					...
					var Pe = function (e, t) {
						var r,
							...
							u = o * i * l;
						if (8 === n) {
							if ((r = s + t * u) >= e.byteArray.length)
								throw new Error('frame exceeds size of pixelData');
							return new Uint8Array(e.byteArray.buffer, r, u);
						}
						if (16 === n) {
							if ((r = s + t * u * 2) >= e.byteArray.length)
								throw new Error('frame exceeds size of pixelData');
							return new Uint8Array(e.byteArray.buffer, r, 2 * u);
						}
						if (1 === n) {
							if ((r = s + t * u * 0.125) >= e.byteArray.length)
								throw new Error('frame exceeds size of pixelData');
							return ye(e.byteArray, r, u);
						}
						if (32 !== n) throw new Error('unsupported pixel format');
						if ((r = s + t * u * 4) >= e.byteArray.length)
							throw new Error('frame exceeds size of pixelData');
					...
					var Te = function (e) {
						...
						return r ? (r.encapsulatedPixelData ? be(e, t) : Pe(e, t)) : null;
					};
					function Ie(e, l) {
						var s = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
							...
							f = 5 < arguments.length ? arguments[5] : void 0,
							d = new Date().getTime(),
							p = { cancelFn: void 0 };
						return (
							(p.promise = new Promise(function (o, i) {
								e.then(
									function (r) {
										var e = Te(r, s),
											t = r.string('x00020010'),
											a = new Date().getTime(),
											n = ne(l, e, t, c);
										(!(function (e, t) {
											e.decache = function () {
											...
											n.then(
												function (e) {
													((e.data = r), (e.sharedCacheKey = u));
													var t = new Date().getTime();
													((e.loadTimeInMS = a - d),
														(e.totalTimeInMS = t - d),
														void 0 !== f &&
															void 0 !== f.imageDoneCallback &&
															f.imageDoneCallback(e),
														o(e));
												},
												function (e) {
													i({ error: e, dataSet: r });
					...
					function Ce(e) {
						return 'dicomweb' === e || 'wadouri' === e ? A : 'dicomfile' === e ? De : void 0;
					}
					function ke(e) {
						var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
							r = fe(e),
						...
						return (
							void 0 === a ? (a = Ce(r.scheme)) : delete t.loader,
							ve.isLoaded(r.url)
								? (function (i, l, e, t, r) {
										var s = 2 < arguments.length && void 0 !== e ? e : 0,
											u = 3 < arguments.length ? t : void 0,
										...
										return {
											promise: new Promise(function (r, t) {
												...
												try {
													...
													return void t({ error: e, dataSet: i });
												}
												e.then(function (e) {
									...
									})(ve.get(r.url, a, e), e, r.frame, r.url, t)
								: Ie(ve.load(r.url, a, e), e, r.frame, r.url, t)
						);
					}
					var Ae = {
						metaData: {
						...
						fileManager: we,
						getEncapsulatedImageFrame: be,
						getUncompressedImageFrame: Pe,
						loadFileRequest: De,
						loadImageFromPromise: Ie,
						getLoaderForScheme: Ce,
						loadImage: ke,
						parseImageId: fe,
						unpackBinaryFrame: ye,
						register: function (e) {
							(e.registerImageLoader('dicomweb', ke),
								e.registerImageLoader('wadouri', ke),
								e.registerImageLoader('dicomfile', ke),
								e.metaData.addProvider(xe));
						},
					};
					function Le(e) {
						C(e);
