						...
						<div className="flex gap-2">
							<DropdownMenu>
								...
								<DropdownMenuContent align="end" className="w-48 rounded-xl">
									<DropdownMenuItem onClick={() => setSelectedGender('all')} className="rounded-lg">
										{selectedGender === 'all' && <Check className="h-4 w-4 mr-2 text-[#0D47A1]" />}
									...
									>
										{selectedGender === 'Male' && <Check className="h-4 w-4 mr-2 text-[#0D47A1]" />}
						...
						<div className="medical-card-header rounded-t-xl">
							<div className="flex items-center justify-between">
								<div className="flex items-center gap-3">
									...
									<div>
										<h3 className="text-base font-semibold text-slate-900">Danh sách bệnh nhân</h3>
