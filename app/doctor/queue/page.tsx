					...
					<Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
						...
						{isLoading ? (
							...
							<div className="py-16 text-center">
								...
								<p className="text-lg font-semibold text-slate-700 mb-2">Không có bệnh nhân đang chờ</p>
								<p className="text-sm text-slate-500">Bạn đã khám xong tất cả bệnh nhân trong hàng đợi</p>
							</div>
						) : (
											...
											<div className="flex items-center gap-6">
												...
												<div className="flex-1 grid grid-cols-[2.5fr_1.5fr_3fr_1.2fr] gap-8 items-center">
													...
													<div className="space-y-0.5">
														...
														{age && (
															<p className="text-xs text-slate-400">{age} tuổi</p>
														)}
													</div>
