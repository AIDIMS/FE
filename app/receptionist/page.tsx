											...
											<div className="flex items-center justify-between">
												<div className="flex-1">
													<div className="flex items-center gap-3 mb-2">
														<p className="font-semibold text-slate-900 text-base">{patient.full_name}</p>
								...
								{waitingQueue.map((visit, index) => (
									...
									>
										<div className="flex items-center gap-5">
											{/* Queue Number */}
											<div className="relative">
												<div className={`flex items-center justify-center w-14 h-14 rounded-2xl font-bold text-xl transition-all ${
													index === 0
											...
											<div className="flex-1 grid grid-cols-4 gap-6 items-center">
												<div>
													...
													<p className="text-sm font-semibold text-slate-900">{visit.patient_code}</p>
												</div>
												<div>
